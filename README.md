...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&pause=1000&color=003FEF&width=435&lines=Full+Stack+Developer;Applied+AI+Developer;Always+Learning+New+Things)](https://git.io/typing-svg)

---

## 👨‍💻 Who Am I?

I build full-stack products and applied AI systems, and I care more about whether they work than whether they demo well. 🤖

| | |
|---|---|
| 🎓 | **BEng Software Engineering** — Seneca Polytechnic, graduated Sept 2026 |
| 💼 | **Systems Development Engineer @ Kubetools** *(Jan–Apr 2026)* |
| 💼 | **Frontend/UI Intern @ Inspired Tech** *(May–Aug 2025)* |

📍 **Based in Canada** — open to AI Engineer and new-grad software roles.

### 🎯 Focus

- 🔭 **Building**: Agentic AI systems, RAG pipelines, full-stack products
- 🌱 **Learning**: Cloud integration & automation — AWS, Docker, CI/CD
- 🎨 **Care about**: Grounded LLM outputs, accessible responsive UI, clean design systems
- 👯 **Open to**: AI/ML open source, applied AI & web architecture work
- 💬 **Ask me**: Agentic systems, RAG, LLMs, & web dev
